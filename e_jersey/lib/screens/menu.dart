...
import 'package:e_jersey/widgets/jersey_card.dart';

class MyHomePage extends StatelessWidget {
    final String npm = '2306241700'; // NPM
    final String name = 'Muhammad Naufal Ramadhan'; // Nama
